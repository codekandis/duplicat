...
/// <summary>Represents the main form of the application.</summary>
	...
	Form
{
	...
	/// <summary>Stores the bindable data source of projects.</summary>
	private BindableDataSource< ProjectInterface > projects;

	/// <summary>Stores the MD5 sets.</summary>
	private Md5SetListInterface md5SetList = new Md5SetList();

	/// <summary>Stores the bindable data source of MD5 sets.</summary>
	...
	/// <summary>Stores the bindable data source of files.</summary>
	...
	/// <summary>Sets all necessary data bindings.</summary>
	...
	/// <summary>Sets the control states.</summary>
	...
	/// <summary>Changes the current project.</summary>
	...
	/// <summary>Changes the current MD5 set.</summary>
	...
	/// <summary>Saves the projects.</summary>
	...
	/// <summary>Opens the folder dialog.</summary>
	...
	/// <summary>Purges the listing from single file entries.</summary>
	private void Purge()
	{
