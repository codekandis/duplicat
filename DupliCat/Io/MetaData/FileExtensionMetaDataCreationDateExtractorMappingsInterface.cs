...
/// <summary>Represents the interface of any file extension meta data creation date extractor mappings.</summary>
internal interface FileExtensionMetaDataCreationDateExtractorMappingsInterface
{
	/// <summary>Gets a file extension meta data creation date extractor by a specific file extension.</summary>
