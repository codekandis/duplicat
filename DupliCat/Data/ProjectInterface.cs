...
/// <summary>Represents the interface of any project.</summary>
	...
	NotifyPropertyInterface
{
	...
	/// <summary>Gets / sets the path.</summary>
	string Path
	{
		get;
		set;
	...
	/// <summary>Gets / sets the patterns.</summary>
	string Patterns
	{
		get;
		set;
	...
	/// <summary>Gets the MD5 sets of the project.</summary>
